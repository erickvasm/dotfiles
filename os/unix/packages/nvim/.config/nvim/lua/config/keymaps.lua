...
-- Resize splits normales con Option+flechas
vim.keymap.set("n", "<A-Right>", "<cmd>vertical resize +5<CR>", { desc = "Increase window width" })
vim.keymap.set("n", "<A-Left>", "<cmd>vertical resize -5<CR>", { desc = "Decrease window width" })
vim.keymap.set("n", "<A-Up>", "<cmd>resize +3<CR>", { desc = "Increase window height" })
vim.keymap.set("n", "<A-Down>", "<cmd>resize -3<CR>", { desc = "Decrease window height" })
